...
type RespExecuteSql struct {
	...
	QueryResult   *QueryResult `protobuf:"bytes,5,opt,name=query_result,json=queryResult" json:"query_result,omitempty"`
}
...
func (x *RespExecuteSql) GetQueryResult() *QueryResult {
	if x != nil {
...
type OneColumnData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ColumnValues []string `protobuf:"bytes,1,rep,name=column_values,json=columnValues" json:"column_values,omitempty"`
}

func (x *OneColumnData) Reset() {
	*x = OneColumnData{}
	if protoimpl.UnsafeEnabled {
...
func (x *OneColumnData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OneColumnData) ProtoMessage() {}

func (x *OneColumnData) ProtoReflect() protoreflect.Message {
	mi := &file_ss_mysql_proxy_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OneColumnData.ProtoReflect.Descriptor instead.
func (*OneColumnData) Descriptor() ([]byte, []int) {
	return file_ss_mysql_proxy_proto_rawDescGZIP(), []int{2}
}

func (x *OneColumnData) GetColumnValues() []string {
	if x != nil {
...
type QueryResult struct {
	...
	Result      []*OneColumnData `protobuf:"bytes,2,rep,name=result" json:"result,omitempty"`
}
...
func (x *QueryResult) GetResult() []*OneColumnData {
	if x != nil {
		return x.Result
	}
	return nil
...
var file_ss_mysql_proxy_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x73, 0x73, 0x22, 0x49, 0x0a, 0x0f, 0x72, 0x65,
	...
	0x52, 0x03, 0x73, 0x71, 0x6c, 0x22, 0xca, 0x01, 0x0a, 0x10, 0x72, 0x65, 0x73, 0x70, 0x5f, 0x65,
	...
	,
	...
	0x73, 0x73, 0x2e, 0x6f, 0x6e, 0x65, 0x5f, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x5f, 0x64, 0x61,
	0x74, 0x61, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x2a, 0x2d, 0x0a, 0x0e, 0x73, 0x73,
	0x5f, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x5f, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x12, 0x1b, 0x0a, 0x16,
	0x6d, 0x73, 0x67, 0x5f, 0x69, 0x64, 0x5f, 0x72, 0x65, 0x71, 0x5f, 0x65, 0x78, 0x65, 0x63, 0x75,
	0x74, 0x65, 0x5f, 0x73, 0x71, 0x6c, 0x10, 0x91, 0x4e, 0x2a, 0x30, 0x0a, 0x0c, 0x64, 0x62, 0x5f,
	0x6f, 0x70, 0x65, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x12, 0x0e, 0x0a, 0x0a, 0x6f, 0x70, 0x65,
	0x72, 0x5f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x6f, 0x70, 0x65,
	0x72, 0x5f, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x10, 0x02,
}
...
var file_ss_mysql_proxy_proto_goTypes = []interface{}{
	...
	(*OneColumnData)(nil),  // 4: ss.one_column_data
	(*QueryResult)(nil),    // 5: ss.query_result
}
var file_ss_mysql_proxy_proto_depIdxs = []int32{
	1, // 0: ss.req_execute_sql.type:type_name -> ss.db_oper_type
	5, // 1: ss.resp_execute_sql.query_result:type_name -> ss.query_result
	4, // 2: ss.query_result.result:type_name -> ss.one_column_data
