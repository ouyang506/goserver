...
// 程序启动时注册，非线程安全
func InitMsgMapping() {
	//RegProtoMsgMapping(int(pb.CsMsgArray[0][1]), pb.CsMsgArray[0][2],pb.CsMsgArray[0][3])

}

// 程序启动时注册，非线程安全
func RegMsgHandler(reqMsgID int, handleFunc interface{}) {
...
// 注册协议映射和处理函数
func RegProtoMsgMapping(reqMsgId int, reqMsg proto.Message, respMsgId int, respMsg proto.Message) {
