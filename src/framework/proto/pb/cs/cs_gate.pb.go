...
const (
	//[1000,1099]定义系统协议
	CsGate_msg_id_req_heart_beat CsGate = 1000
	//[1100-1999]定义业务协议
	CsGate_msg_id_req_login_gate CsGate = 1100
	CsGate_msg_id_notify_tooltip CsGate = 1101
)

// Enum value maps for CsGate.
var (
	CsGate_name = map[int32]string{
		1000: "msg_id_req_heart_beat",
		1100: "msg_id_req_login_gate",
		1101: "msg_id_notify_tooltip",
	}
	CsGate_value = map[string]int32{
		"msg_id_req_heart_beat": 1000,
		"msg_id_req_login_gate": 1100,
		"msg_id_notify_tooltip": 1101,
	}
)
...
var file_cs_gate_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x72, 0x74, 0x5f, 0x62, 0x65, 0x61, 0x74, 0x10, 0xe8, 0x07, 0x12, 0x1a, 0x0a, 0x15,
	0x6d, 0x73, 0x67, 0x5f, 0x69, 0x64, 0x5f, 0x72, 0x65, 0x71, 0x5f, 0x6c, 0x6f, 0x67, 0x69, 0x6e,
	0x5f, 0x67, 0x61, 0x74, 0x65, 0x10, 0xcc, 0x08, 0x12, 0x1a, 0x0a, 0x15, 0x6d, 0x73, 0x67, 0x5f,
